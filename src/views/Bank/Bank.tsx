...
import { Bank as BankEntity } from '../../haunted-finance';
...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  const hauntedAddr = hauntedFinance.HAUNTED.address;
  const hshareAddr = hauntedFinance.HSHARE.address;
    ...
    <Card>
      <CardContent>
        <StyledLink href={uniswapUrl} target="_blank">
          {` Provide liquidity for ${pairName} now on XDC Swap `}
        </StyledLink>
      </CardContent>
    </Card>
  );
