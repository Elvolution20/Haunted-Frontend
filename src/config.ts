...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    pgscanUrl: 'https://xinfin.org',
    defaultProvider: 'https://explorer.xinfin.network/',
    deployments: require('./haunted-finance/deployments/deployments.testing.json'),
    externalTokens: {
      WPG: ['0xf1277d1ed8ad466beddf92ef448a132661956621', 18],
      'HAUNTED-PG-LP': ['0x13Fe199F19c8F719652985488F150762A5E9c3A8', 18],
      'HSHARE-PG-LP': ['0x20bc90bB41228cb9ab412036F80CE4Ef0cAf1BD5', 18],
    },
  ...
  production: {
    chainId: 50,
    networkName: 'XinFin Apothem Mainnet',
    pgscanUrl: 'https://explorer.xinfin.network/',
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  HauntedFtmRewardPool: {
    name: 'Earn HAUNTED by PG',
    poolId: 0,
    sectionInUI: 0,
    contract: 'HauntedFtmRewardPool',
    depositTokenName: 'WPG',
  ...
  HauntedFtmLPHauntedRewardPool: {
    name: 'Earn HAUNTED by HAUNTED-PG LP',
    poolId: 0,
    sectionInUI: 1,
    contract: 'HauntedFtmLpHauntedRewardPool',
    depositTokenName: 'HAUNTED-PG-LP',
    earnTokenName: 'HAUNTED',
    finished: false,
    sort: 5,
    closedForStaking: true,
  ...
  HauntedFtmLPHShareRewardPool: {
    name: 'Earn HSHARE by HAUNTED-PG LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  HshareFtmLPHShareRewardPool: {
    name: 'Earn HSHARE by HSHARE-PG LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'HshareFtmLPHShareRewardPool',
    depositTokenName: 'HSHARE-PG-LP',
    earnTokenName: 'HSHARE',
    finished: false,
    sort: 7,
    closedForStaking: false,
